...
<body>
        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" style="color: #fdce64;" href="bouquet.php">BOUQUET</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="content">
        <div class="container">
            <div class="images">
                <br><br>
                <img src="img/adv13.jpeg" class="main-img">
                <img src="img/adv14.webp" class="secondary-img">
            </div>
            <div class="second">
                <br><br>
                <img src="img/adv15.jpg" class="third-img">
            </div>
            <center>
    ...
    <div class="adv">
        <center>
            <br><br>
            <p>"Our team of expert wedding designers is dedicated to making your special day perfect, offering creative solutions and impeccable service."</p>
            <br>
            <div class="row">
    ...
    <div class="container">
        <div class="heading">
            <center>
                <h1>AVAILABLE BOUQUET SETS & PRODUCTS</h1>
    ...
    <div class="container">
        <div class="row">
            <?php
                ...
                $data = "SELECT * FROM bouquet ORDER BY no DESC";
                $val = $con->query($data);
                if ($val -> num_rows > 0) {
