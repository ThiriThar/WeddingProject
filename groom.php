...
<body>
        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" style="color: #fdce64;" href="groom.php">GROOM</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="content">
        <div class="container">
            <div class="images">
                <br><br>
                <img src="img/adv1.jpg" class="main-img">
                <img src="img/adv2.jpg" class="secondary-img">
            </div>
            <div class="second">
                <br><br>
                <img src="img/adv3.webp" class="third-img">
            </div>
            <center>
    ...
    <div class="adv">
        <center>
            <br><br>
            <p>"Our wedding designer company transforms your dream wedding into a breathtaking reality, ensuring every detail reflects your unique love story."</p>
            <br>
            <div class="row">
    ...
    <div class="container">
        <div class="heading">
            <center>
                <h1>AVAILABLE GROOM & GROOMSMEN PRODUCTS</h1>
    ...
    <div class="container">
        <div class="row">
            <?php
                ...
                $data = "SELECT * FROM groom ORDER BY no DESC";
                $val = $con->query($data);
                if ($val -> num_rows > 0) {
