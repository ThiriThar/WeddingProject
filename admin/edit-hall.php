...
<body>
    ...
    <center>
        <div class="box container">
            <br>
            <h3 style="color: #fdce64;">Edit Hall Items</h3>
            <?php
                error_reporting(1);
                include('connection.php');
                $no = $_GET['no'];
                $val = $con -> query("SELECT * FROM hall WHERE no=$no");
                ...
                if(isset($_POST['edit'])) {
                    ...
                    $con -> query("UPDATE hall SET Type='$add_name', Hour='$add_hour', Price='$add_price' WHERE no=$no");
