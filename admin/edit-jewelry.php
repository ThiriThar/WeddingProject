...
<body>
    ...
    <center>
        <div class="box container">
            <br>
            <h3 style="color: #fdce64;">Edit Jewelry Items</h3>
            <?php
                error_reporting(1);
                include('connection.php');
                $no = $_GET['no'];
                $val = $con -> query("SELECT * FROM jewelry WHERE no=$no");
                ...
                if(isset($_POST['edit'])) {
                    ...
                    $con -> query("UPDATE jewelry SET Name='$add_name', Price='$add_price' WHERE no=$no");
                    header('location:jewelry.php');
                }
            ?>
            <div class="addJewelry">
