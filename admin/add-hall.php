...
<body>
    ...
    <center>
        <div class="box container">
            <br>
            <h3 style="color: #fdce64;">Add Hall Items</h3>
            <?php
                error_reporting(1);
                ...
                if(isset($_POST['add'])) {
                    ...
                    $query = mysqli_query($con, "INSERT INTO hall(type, hour, price, image) value ('$add_name', '$add_hour', '$add_price', '$img')");
