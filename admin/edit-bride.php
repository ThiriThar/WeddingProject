...
<body>
    ...
    <center>
        <div class="box container">
            <br>
            <h3 style="color: #fdce64;">Edit Bride Items</h3>
            <?php
                error_reporting(1);
                include('connection.php');
                $no = $_GET['no'];
                $val = $con -> query("SELECT * FROM bride WHERE no=$no");
                ...
                if(isset($_POST['edit'])) {
                    ...
                    $con -> query("UPDATE bride SET Dress='$add_name', Perfume='$add_perfume', Price='$add_price', Size='$add_size' WHERE no=$no");
            ...
            <div class="addBride">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" id="name" name="name" value="<?php echo $data['Dress'] ?>" required><br><br>
