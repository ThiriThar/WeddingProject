...
<body>
    ...
    <center>
        <div class="box container">
            <br>
            <h3 style="color: #fdce64;">Edit Food Items</h3>
            <?php
                error_reporting(1);
                include('connection.php');
                $no = $_GET['no'];
                $val = $con -> query("SELECT * FROM food WHERE no=$no");
                ...
                if(isset($_POST['edit'])) {
                    ...
                    $con -> query("UPDATE food SET Name='$add_name', Price='$add_price', Quantity='$add_quantity' WHERE no=$no");
            ...
            <div class="addFood">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" id="quantity" name="quantity" value="<?php echo $data['Quantity'] ?>" required><br><br>
