...
<body>
    ...
    <center>
        <div class="box container">
            <br>
            <h3 style="color: #fdce64;">Add Groom Items</h3>
            <?php
                error_reporting(1);
                ...
                if(isset($_POST['add'])) {
                    ...
                    $query = mysqli_query($con, "INSERT INTO groom(suit, perfume, price, size, image) value ('$add_name', '$add_perfume', '$add_price', '$add_size', '$img')");

                    if($query) {
                        move_uploaded_file($_FILES['image']['tmp_name'],"img/".$img);
                        echo "<script>alert('New item has been successfully added.');</script>";
                        echo "<script>window.location.href = 'groom.php'</script>";
                    }
                    else {
            ...
            <div class="addGroom"><br>
                <form method="POST" enctype="multipart/form-data">
                    <label for="suit">Suit:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="text" id="suit" name="suit" required><br><br>

                    <label for="perfume">Perfume:</label>&nbsp;&nbsp;
                    <input type="text" id="perfume" name="perfume" required><br><br>
