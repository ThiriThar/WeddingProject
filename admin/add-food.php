...
<body>
    ...
    <center>
        <div class="box container">
            <br>
            <h3 style="color: #fdce64;">Add Food Items</h3>
            <?php
                error_reporting(1);
                ...
                if(isset($_POST['add'])) {
                    ...
                    $query = mysqli_query($con, "INSERT INTO food(name, price, quantity, image) value ('$add_name', '$add_price', '$add_quantity', '$img')");
