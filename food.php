...
<body>
        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" style="color: #fdce64;" href="food.php">FOOD</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="content">
        <div class="container">
            <div class="images">
                <br><br>
                <img src="img/adv16.webp" class="main-img">
                <img src="img/adv17.jpg" class="secondary-img">
            </div>
            <div class="second">
                <br><br>
                <img src="img/adv18.jpeg" class="third-img">
            </div>
            <center>
    ...
    <div class="adv">
        <center>
            <br><br>
            <p>"From intimate gatherings to grand celebrations, our wedding designer company delivers exceptional events that exceed expectations."</p>
            <br>
            <div class="row">
    ...
    <div class="container">
        <div class="heading">
            <center>
                <h1>AVAILABLE FOOD & DRINKS IN RESTAURANTS</h1>
    ...
    <div class="container">
        <div class="row">
            <?php
                ...
                $data = "SELECT * FROM food ORDER BY no DESC";
                $val = $con->query($data);
                if ($val -> num_rows > 0) {
                    while (list ($no, $name, $price, $quantity, $img) = mysqli_fetch_array($val)) {
