...
<body>
        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" style="color: #fdce64;" href="makeup.php">MAKEUP</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="content">
        <div class="container">
            <div class="images">
                <br><br>
                <img src="img/adv10.jpg" class="main-img">
                <img src="img/adv11.jpg" class="secondary-img">
            </div>
            <div class="second">
                <br><br>
                <img src="img/adv12.jpg" class="third-img">
            </div>
            <center>
    ...
    <div class="adv">
        <center>
            <br><br>
            <p>"We specialize in crafting personalized wedding experiences, tailoring each element to match your vision and style."</p>
            <br>
            <div class="row">
    ...
    <div class="container">
        <div class="heading">
            <center>
                <h1>AVAILABLE MAKEUP LOOKS & PRODUCTS</h1>
