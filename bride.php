...
<body>
        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" style="color: #fdce64;" href="bride.php">BRIDE</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="content">
        <div class="container">
            <div class="images">
                <br><br>
                <img src="img/adv4.webp" class="main-img">
                <img src="img/adv5.webp" class="secondary-img">
            </div>
            <div class="second">
                <br><br>
                <img src="img/adv6.png" class="third-img">
            </div>
            <center>
    ...
    <div class="adv">
        <center>
            <br><br>
            <p>"With a focus on elegance and sophistication, our wedding designers create bespoke celebrations that leave a lasting impression on you and your guests."</p>
            <br>
            <div class="row">
    ...
    <div class="container">
        <div class="heading">
            <center>
                <h1>AVAILABLE BRIDE & BRIDESMAID PRODUCTS</h1>
    ...
    <div class="container">
        <div class="row">
            <?php
                ...
                $data = "SELECT * FROM bride ORDER BY no DESC";
                $val = $con->query($data);
                if ($val -> num_rows > 0) {
                    while (list ($no, $name, $perfume, $price, $size, $img) = mysqli_fetch_array($val)) {
