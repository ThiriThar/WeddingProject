...
<head>
    ...
    <title>BORCELLE Entertainment</title>
...
<body>
        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" style="color: #fdce64;" href="entertainment.php">ENTERTAINMENT</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="content">
        <div class="container">
            <div class="images">
                <br><br>
                <img src="img/adv22.jpg" class="main-img">
                <img src="img/adv23.webp" class="secondary-img">
            </div>
            <div class="second">
                <br><br>
                <img src="img/adv24.jpg" class="third-img">
            </div>
            <center>
    ...
    <div class="adv">
        <center>
            <br><br>
            <p>"Our wedding designers collaborate closely with you to bring your vision to life, using our expertise to create a day that is uniquely yours."</p>
            <br>
            <div class="row">
    ...
    <div class="container">
        <div class="heading">
            <center>
                <h1>AVAILABLE ENTERTAINMENT TYPES</h1>
    ...
    <div class="container">
        <div class="row">
            <?php
                ...
                $data = "SELECT * FROM entertainment ORDER BY no DESC";
                $val = $con->query($data);
                if ($val -> num_rows > 0) {
                    while (list ($no, $name, $hour, $price, $img) = mysqli_fetch_array($val)) {
                        echo "<div class='col-4'>
                                ...
                                <div class='card'>
                                    ...
                                    <div class = 'card-content'>
                                        <center><h2>$name</h2>
                                        <p>Renting Hours - $hour</p>
                                        <p>Price - $$price</p>
                                        <a href = 'booking.php? name=$name&price=$price'>
