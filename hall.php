...
<body>
        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" style="color: #fdce64;" href="hall.php">HALL</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="content">
        <div class="container">
            <div class="images">
                <br><br>
                <img src="img/adv19.jpg" class="main-img">
                <img src="img/adv20.jpg" class="secondary-img">
            </div>
            <div class="second">
                <br><br>
                <img src="img/adv21.jpg" class="third-img">
            </div>
            <center>
    ...
    <div class="adv">
        <center>
            <br><br>
            <p>"Let us take care of the details, from stunning decor to seamless coordination, ensuring your wedding day is flawless and magical."</p>
            <br>
            <div class="row">
    ...
    <div class="container">
        <div class="row">
            <?php
                ...
                $data = "SELECT * FROM hall ORDER BY no DESC";
                $val = $con->query($data);
                if ($val -> num_rows > 0) {
